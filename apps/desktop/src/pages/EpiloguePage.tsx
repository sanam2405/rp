...
export const EpiloguePage: FC = () => {
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center py-20 h-screen md:h-auto dark:bg-black bg-white relative w-full overflow-y-auto">
        <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-8">
          ...
          >
            ...
            <p className="text-center text-lg font-normal text-neutral-700 dark:text-neutral-200 max-w-3xl mt-2 mx-auto">
              ...
              back and forth, as it threw me left and threw me right, and before
              I knew it; nobody buys yesterday's lottery ticket. I came to
              Tequip, the day you made the first big breakthrough of your
              career. There you were, anxiously waiting for the selection list
              and I maintained distance, lest I bring some bad luck to you.
              After a long wait, the list came. You were selected. You hugged
              all of your friends in room 208 of Tequip and eventually turned
              back and smiled at me. I wanted to come up to you and tell you all
              this in person, but I just watched you smile. You looked
              beautiful. You are young, you can dream, and for sometime you let
              me into your dreams. And I want to thank you for that.
              <br />
