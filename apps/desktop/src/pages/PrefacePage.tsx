import { Aura, World } from "@/components";
import { motion } from "framer-motion";
import { FC } from "react";
import "../backdrop.css";
import "../globals.css";

export const PrefacePage: FC = () => {
  const globeConfig = {
    pointSize: 4,
    globeColor: "#062056",
    showAtmosphere: true,
        ...
        <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-8">
          ...
          >
            ...
            <p className="text-center text-lg font-normal text-neutral-700 dark:text-neutral-200 max-w-3xl mt-2 mx-auto">
              ...
              unfolded in the local trains, JU OAT, on the banks of the Padma
              and Ganga, and through Sikkim's old silk route trails.{" "}
              <b>
                <i> RP</i>
              </b>{" "}
