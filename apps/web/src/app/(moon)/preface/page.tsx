...
const World = dynamic(() => import("@/components").then((mod) => mod.World), {
  ssr: false,
});

export default function RPWorld() {
  const globeConfig = {
    pointSize: 4,
    globeColor: "#062056",
    showAtmosphere: true,
      ...
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-8">
        ...
        >
          ...
          <p className="text-center text-lg font-normal text-neutral-700 dark:text-neutral-200 max-w-3xl mt-2 mx-auto">
            The <i>git init</i> that began on April Fool's Day, 2024, in my
            fevered haze—the same day my FTE offer came through. Its journey
            unfolded in the local trains, JU OAT, on the banks of the Padma and
            Ganga, and through Sikkim's old silk route trails.{" "}
            <b>
              <i> RP</i>
            </b>{" "}
            continues to exude her presence through the places that I have
